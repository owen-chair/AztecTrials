...
namespace SaccFlightAndVehicles
{
    ...
    public class DFUNC_Grapple : UdonSharpBehaviour
    {
        ...
        public GameObject CurrentGrappleHookAttachment;
        ...
        public Vector3 HookAttachPoint
        {
            set
            {
                ...
                if (nearestDist < float.MaxValue)
                {
                    ...
                    CurrentGrappleHookAttachment = HookedGameObject;
        ...
        public void ResetHook()
        {
            ...
            if (HookAttached)
            {
                ...
                CurrentGrappleHookAttachment = null;
                HookAttached = false;
            }
            NonLocalAttached = false;
        ...
        public void ForceDetachGrappleHookAttachment()
        {
            if (IsOwner)
            {
                HookLaunched = false;
        ...
        {
            // commented to sync event callbaks - can delete if this doesnt become a problem
            //if (!IsOwner) { return; }
