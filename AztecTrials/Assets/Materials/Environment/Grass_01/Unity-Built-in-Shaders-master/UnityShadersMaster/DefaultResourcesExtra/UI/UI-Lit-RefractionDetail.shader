...
Shader "UnityShadersMaster/UI/Lit/Refraction Detail"
{
    Properties
    {
    ...
    SubShader
    {
        ...
        CGPROGRAM
            ...
            #include "Assets/Materials/Environment/Grass_01/Unity-Built-in-Shaders-master/UnityShadersMaster/CGIncludes/UnityUI.cginc"
    ...
    Fallback "UnityShadersMaster/UI/Lit/Detail"
}
