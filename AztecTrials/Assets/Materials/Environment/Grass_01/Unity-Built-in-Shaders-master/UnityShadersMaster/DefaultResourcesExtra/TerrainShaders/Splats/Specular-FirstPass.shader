...
Shader "UnityShadersMaster/Nature/Terrain/Specular" {
    Properties {
    ...
    Dependency "AddPassShader"    = "UnityShadersMaster/Hidden/TerrainEngine/Splatmap/Specular-AddPass"
    Dependency "BaseMapShader"    = "UnityShadersMaster/Hidden/TerrainEngine/Splatmap/Specular-Base"
