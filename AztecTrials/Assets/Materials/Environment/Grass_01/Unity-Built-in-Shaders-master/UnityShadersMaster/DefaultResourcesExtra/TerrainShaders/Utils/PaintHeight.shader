// Unity built-in shader source. Copyright (c) 2016 Unity Technologies. MIT license (see license.txt)
    ...
    Shader "UnityShadersMaster/Hidden/TerrainEngine/PaintHeight" {
    ...
    SubShader {
        ...
        CGINCLUDE
            ...
            #include "Assets/Materials/Environment/Grass_01/Unity-Built-in-Shaders-master/UnityShadersMaster/CGIncludes/TerrainTool.cginc"
