...
Shader "UnityShadersMaster/Hidden/TextCore/Distance Field SSD"
{
    Properties
    {
    ...
    SubShader
    {
        ...
        Pass
        {
            ...
            #include "Assets/Materials/Environment/Grass_01/Unity-Built-in-Shaders-master/UnityShadersMaster/CGIncludes/TextCoreProperties.cginc"
