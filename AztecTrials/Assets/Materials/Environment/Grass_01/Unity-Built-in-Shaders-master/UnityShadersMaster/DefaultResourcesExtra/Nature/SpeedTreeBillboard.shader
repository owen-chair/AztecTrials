...
Shader "UnityShadersMaster/Nature/SpeedTree Billboard"
{
    Properties
    {
    ...
    SubShader
    {
        ...
        CGPROGRAM
            ...
            #define ENABLE_WIND
            #include "Assets/Materials/Environment/Grass_01/Unity-Built-in-Shaders-master/UnityShadersMaster/CGIncludes/SpeedTreeBillboardCommon.cginc"
