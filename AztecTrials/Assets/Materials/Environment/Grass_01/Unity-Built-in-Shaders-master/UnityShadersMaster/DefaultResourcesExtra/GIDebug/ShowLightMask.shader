...
Shader "UnityShadersMaster/Hidden/GIDebug/ShowLightMask" {
    Properties {
    ...
    SubShader {
        Pass {
            ...
            #include "Assets/Materials/Environment/Grass_01/Unity-Built-in-Shaders-master/UnityShadersMaster/CGIncludes/UnityShaderVariables.cginc"
            #include "Assets/Materials/Environment/Grass_01/Unity-Built-in-Shaders-master/UnityShadersMaster/CGIncludes/UnityShadowLibrary.cginc"
