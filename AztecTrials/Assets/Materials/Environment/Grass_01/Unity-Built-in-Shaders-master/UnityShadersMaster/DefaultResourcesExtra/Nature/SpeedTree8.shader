...
Shader "UnityShadersMaster/Nature/SpeedTree8"
{
    Properties
    {
    ...
    SubShader
    {
        ...
        CGPROGRAM
            ...
            #include "Assets/Materials/Environment/Grass_01/Unity-Built-in-Shaders-master/UnityShadersMaster/CGIncludes/SpeedTree8Common.cginc"
