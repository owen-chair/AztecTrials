...
Shader "UnityShadersMaster/Hidden/Internal-UIRDefault"
{
    Properties
    {
    ...
    Category
    {
        ...
        SubShader
        {
            ...
            Pass
            {
                ...
                #define UIE_SDF_TEXT
                #include "Assets/Materials/Environment/Grass_01/Unity-Built-in-Shaders-master/UnityShadersMaster/CGIncludes/UnityUIE.cginc"
                ENDCG
            }
        }
