...
Shader "UnityShadersMaster/Nature/SpeedTree"
{
    Properties
    {
    ...
    SubShader
    {
        ...
        CGPROGRAM
            ...
            #define ENABLE_WIND
            #include "Assets/Materials/Environment/Grass_01/Unity-Built-in-Shaders-master/UnityShadersMaster/CGIncludes/SpeedTreeCommon.cginc"
    ...
    Dependency "BillboardShader" = "UnityShadersMaster/Nature/SpeedTree Billboard"
