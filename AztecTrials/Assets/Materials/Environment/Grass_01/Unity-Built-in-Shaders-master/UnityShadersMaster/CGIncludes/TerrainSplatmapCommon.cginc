...
#endif
{
    ...
    #if defined(TERRAIN_SINGLE_LAYER)
        // Single Terrain Layer optimization: only use the first control channel.
        half control0 = tex2D(_Control, splatUV).r;
        splat_control = half4(control0, 0, 0, 0);
        weight = control0;
    #else
