...
// - UNITY_SETUP_STEREO_EYE_INDEX_POST_VERTEX
    ...
    // Use unity_StereoEyeIndex directly (avoids requiring unity_StereoEyeIndices to be declared).
    #define DEFAULT_UNITY_INITIALIZE_VERTEX_OUTPUT_STEREO(output) output.stereoTargetEyeIndex = (float)unity_StereoEyeIndex;
    #define DEFAULT_UNITY_TRANSFER_VERTEX_OUTPUT_STEREO(input, output) output.stereoTargetEyeIndex = input.stereoTargetEyeIndex;
